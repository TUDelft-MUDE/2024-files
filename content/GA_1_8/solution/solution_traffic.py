...
data_path = os.path.join(os.path.dirname(__file__),
                         'data', 
                         data_set+'.csv')
figure_path = os.path.join(os.path.dirname(__file__),
                           'figures', data_set)

# bivariate_lim = [-20, 29, 0, 180
bivariate_lim = [0, 180, -20, 80]
...
plt.savefig(os.path.join(figure_path,'figure_1.svg'))
...
if make_figs:
    ...
    if save_figs:
        plt.savefig(os.path.join(figure_path,'figure_5.svg'))
...
if make_figs:
    ...
    axes.grid()
    if save_figs:
        plt.savefig(os.path.join(figure_path,'figure_6.svg'))
...
if make_figs:
    ...
    axes.grid()
    if save_figs:
        plt.savefig(os.path.join(figure_path,'figure_7.svg'))