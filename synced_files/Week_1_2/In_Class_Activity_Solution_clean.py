...
# + [markdown] cell_id="9a082db4cf644c9c9854af0a458c0b8a" deepnote_cell_type="markdown"
...
# + [markdown] cell_id="604f11f41ac54d59b11422bac89e6411" deepnote_cell_type="markdown"
# <div style="background-color:#FAE99E; color: black; width:95%; vertical-align: middle; padding:15px; margin: 10px; border-radius: 10px">
# <p>
#
# $\textbf{Solution}$
